...
if (!function_exists('success')) {
	 ...
	 * @return array
	 */
	function success($data = [], $msg = '', $code = SUCCESS, $url = '')
	{
        $msg = $msg ?: trans('custom.SUCCESS');
...
if (!function_exists('fail')) {
	 ...
	 * @return array
	 */
	function fail($msg = '', $code = FAIL, $data = [])
	{
		$data or $data = [];
        $msg = $msg ?: trans('custom.FAIL');
...
if (!function_exists('trans_replace')) {
    function trans_replace($code, array $param)
    {
        $str = trans($code);
